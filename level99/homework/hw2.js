...
// პირობები
if (username === "გიორგი" == age > 18) {
  console.log("your name is giorgi and you are adult")
} else if (username === "ნიკა" == age < 18 == age > 11) {
  console.log("your name is nika and you are younger")
} else if ((username === "saba" || username === "irakli") == age < 11 == age > 5) {
