//)შექმენით ფუნქცია რომელსაც გადასცემთ არგუმენტად სიას --> ["გიორგი" , 14 , "საბა" , 90.5 , "ირაკლი" , true]
...
function modifyArray(arr) {
  ...
  console.log("შეცვლილი სია:", arr);
}


modifyArray(["გიორგი", 14, "საბა", 90.5, "ირაკლი", true]);
